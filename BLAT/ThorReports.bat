...
::if exist D:\thorfiles\REP_*.csv C:\BLAT\BLAT.EXE -body "Reports attached." -server 1.2.3.4 -u administration@transactortech.com -pw passwd -f donotreply@transactortech.com -subject "Farmers Reports" -try 30 -to Sherilyn.Jonkers@farmers.co.nz -bcc andy.saputra@transactortech.com,reports@transactortech.com -attach D:\thorfiles\REP_*.csv
